package com.dennis114514.looktheworld.Games.HonkaiStarRailway;
...
public class HonkaiStarRailwayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 设置自定义顶栏
        CustomToolbarHelper.setupToolbar(this, getString(R.string.honkai_star_railway));
    }
